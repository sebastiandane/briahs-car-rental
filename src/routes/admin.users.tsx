...
const roleSummary = [
  {
    role: "Admin",
    icon: ShieldCheck,
    perms: ["Full dashboard access", "Bookings", "Fleet", "Payments", "Reports"],
  },
  {
    role: "Customer",
    icon: User,
    perms: ["Booking requests", "Payment uploads", "Account profile", "Rental history"],
  },
];
...
function UsersPage() {
  return (
    <div>
      <PageHeader
        title="Users & roles"
        subtitle="Manage admin access and customer account permissions."
        actions={
          <Btn variant="primary">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  {r.role === "Customer" ? "Customer account" : "Admin account"}
                </div>
              </div>
            </div>
      ...
      <Card className="mt-6">
        <CardHeader title="Accounts" hint={`${users.length} admin and customer accounts`} />
